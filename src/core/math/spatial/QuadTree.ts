...
export class QuadTree {
	...
	public insert(entity: ShapeEntity): boolean {
		...
		return this.northWest!.insert(entity) || this.northEast!.insert(entity) || this.southWest!.insert(entity) || this.southEast!.insert(entity);
	}
	...
	private subdivide(): void {
		...
		for (const entity of entitiesToRedistribute) {
			const inserted = this.northWest.insert(entity) || this.northEast.insert(entity) || this.southWest.insert(entity) || this.southEast.insert(entity);
	...
	public getAllEntities(): ShapeEntity[] {
		...
		if (this.divided) {
			all = all.concat(this.northWest!.getAllEntities(), this.northEast!.getAllEntities(), this.southWest!.getAllEntities(), this.southEast!.getAllEntities());
		}
