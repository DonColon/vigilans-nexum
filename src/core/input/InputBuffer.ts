...
export class InputBuffer {
	 ...
	 */
	public add(channel: InputChannelType, input: InputType, state: InputStateType): void {
	 ...
	 */
	public has(channel: InputChannelType, input: InputType, state?: InputStateType): boolean {
	 ...
	 */
	public consume(channel: InputChannelType, input: InputType, state?: InputStateType): boolean {
	 ...
	 */
	public get(channel?: InputChannelType, input?: InputType, state?: InputStateType): BufferedInput[] {
