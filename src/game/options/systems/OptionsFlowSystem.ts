 ...
 */
export class OptionsFlowSystem extends ReactiveSystem {
	...
	public dispose(): void {
		...
		this.unwatchFullscreen = undefined;
	...
	private watchFullscreen(): void {
		...
		this.unwatchFullscreen = display?.addFullscreenListener((fullscreen) => adoptFullscreen(fullscreen));
	}
	...
	private disarmFullscreenRestore(): void {
		...
		this.restoreFullscreen = undefined;
