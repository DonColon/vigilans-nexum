...
export { buildUnit, getWeapon, getUnitClass, WeaponType, UnitFaction } from "@/game/units/model/UnitData";
export type { UnitData, UnitDocument, UnitStats, WeaponData, UnitClassData } from "@/game/units/model/UnitData";
